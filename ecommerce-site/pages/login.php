 ...
 * Respecte l'arborescence : ecommerce/pages/login.php
 */ 
// Inclusion des fonctions (remonte d'un niveau pour atteindre includes/)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if (login_user($username, $password)) {
            ...
            // Nettoyage de la redirection pour éviter les attaques
            $allowed_redirects = ['cart', 'checkout', 'profile', 'orders'];
            if (in_array($redirect, $allowed_redirects)) {
                $redirect = '../pages/' . $redirect . '.php';
            } else {
                $redirect = '../index.php';
            }
            
            // Message de succès en session
            $_SESSION['message'] = "Connexion réussie ! Bienvenue " . $_SESSION['first_name'] . " !";
